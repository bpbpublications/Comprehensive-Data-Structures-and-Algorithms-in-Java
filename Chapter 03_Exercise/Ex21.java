//Ex21.java : Write a method to create a linked list that is union of two single linked lists.
...
class SingleLinkedList
{
	...
	public void unionLists(SingleLinkedList list2, SingleLinkedList list3)
	{
		Node p = start;
