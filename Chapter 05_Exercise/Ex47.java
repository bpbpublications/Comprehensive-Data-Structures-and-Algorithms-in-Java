//Ex47.java : Write a recursive function to check if two linked lists are identical. Two lists are identical if they have same 
...
class SingleLinkedList
{
	...
	private boolean isIdentical(Node p1, Node p2)
	{
			...
			return isIdentical(p1.link, p2.link);
	}//End of isIdentical()	
